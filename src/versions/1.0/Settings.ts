...
export class Settings extends BaseSettings {
    ...
    constructor(settingsJSON?: any) {
        ...
        this._settings = {
            ...
            settings_version: new Setting('1.0', (v:any) => true),
            ...
            controlNames: new Setting(null, (v) => (v:any) => true),
            controlOrder: new Setting(null, (v) => (v:any) => true),
            ...
            parametersHidden: new Setting(null, (v) => (v:any) => true),
